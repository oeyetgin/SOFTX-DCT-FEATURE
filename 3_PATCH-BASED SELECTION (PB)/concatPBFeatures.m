function [PBC64,PBC32,PBC16] = concatPBFeatures(PBvariable1,PBvariable2,PBvariable3)
...
%%%%%%% 64x64 %%%%%%%
        ...
        for i=2:p64 %% Number of 64x64 size patch in 128x128 %%
...
%%%%%%% 32x32 %%%%%%%
        ...
        for i=2:p32 %% Number of 32x32 size patch in 128x128 %%
...
%%%%%%% 16x16 %%%%%%%
        ...
        for i=2:p16 %% Number of 16x16 size patch in 128x128 %%
